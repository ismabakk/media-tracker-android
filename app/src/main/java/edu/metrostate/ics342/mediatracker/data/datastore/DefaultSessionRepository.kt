...
class DefaultSessionRepository(
    ...
    override suspend fun saveSession(
        ...
        context.dataStore.edit { preferences ->
            ...
            preferences[Keys.USER_JSON] = json.encodeToString(user)
        }
    }
    ...
    override suspend fun getUser(): UserProfile? {
        val userJson = context.dataStore.data.first()[Keys.USER_JSON]
        return userJson?.let { json.decodeFromString<UserProfile>(it) }
    }
